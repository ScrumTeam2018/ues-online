                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i>Falcutad <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../../../produccion/Administracion/Facultad/listarFacultad.php">Modificaci&oacute;n</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-home"></i>Representante <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../../../produccion/Administracion/Representante/listarRepresentante.php">Modificaci&oacute;n</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i>Carrera <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../../../produccion/Administracion/carrera/listarCarreraDarAlta.php">Dar Alta</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-clone"></i>Tutor <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
