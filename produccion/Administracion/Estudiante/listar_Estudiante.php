...
function ver(id){
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
       ...
       <?php include '../../global/navigation.php' ?>
        ...
        <div class="row" >
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h4 style="color:RGB(205, 92, 92);">Lista de Estudiantes Activos.</h4>
                  ...
                  <div class="x_content">
                    ...
                    <div class="responsive-table">
                      ...
                      $con=conectarMysql();
                      $result = $con->query("SELECT es.idestudiante, es.carnet_es, es.nombre_es, es.apellido_es,  es.idfacultad, es.idcarrera, ca.nombre_ca FROM estudiante as es, carrera as ca WHERE es.idcarrera=ca.idcarrera AND es.estado_es=1");
                      $contador=1;
                      if ($result) {
                        while ($fila = $result->fetch_object()) {
                          ...
                          echo "<td> <a class='btn btn-success openBtn' type='button' onclick='ver(".$fila->idestudiante.")'><i class='fa fa-eye'></i></a>
                                     <a class='btn btn-info' onclick='modify(".$fila->idestudiante.")' ><i class='fa fa-edit'></i></a>
                                     <a class='btn btn-danger' onclick='confirmar(".$fila->idestudiante.")' ><i class='fa fa-long-arrow-down'></i></a>
                                      </td>";
                          echo "</tr>";
                          $contador++;
                    ...
                    <div class="modal-dialog ">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel" style="color: RGB(0, 0, 128);">Expediente Estudiantil</h4>
                        </div>
    ...
    <script src="../../../build/config/validaciones/estudiante/validarbaja.js"></script>
  </body>
</html>
