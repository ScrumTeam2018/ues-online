                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      $con=conectarMysql();
                      $result = $con->query("SELECT fa.idfacultad, fa.nombre_fa, fa.telefono_fa, fa.correo_fa, re.nombre_rf FROM facultad as fa, representante_facultad as re WHERE fa.estado_fa=1 AND fa.id_re_fafk= re.id_re_fa;
                      $contador=1;
                      if ($result) {
                        while ($fila = $result->fetch_object()) {
                          ...
                          echo "<td>" . $fila->correo_fa . " Años</td>";
                          echo "<td>" . $fila->nombre_rf . "</td>";
                          echo "<td> <a class='btn btn-app' onclick='modify(".$fila->idfacultad.")' ><i class='fa fa-edit'></i></a>
                                     <a class='btn btn-app' onclick='confirmar(".$fila->idfacultad.")' ><i class='fa fa-long-arrow-down'></i></a>
                                      </td>";
                          echo "</tr>";
                          $contador++;
