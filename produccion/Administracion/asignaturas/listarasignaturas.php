       ...
       <?php include '../../global/navigation.php' ?>
        ...
        <div class="page-title">
              <div class="col-sm-12 col-sm-offset-1 col-md-10 col-md-offset-1 ">
                <h3 style="color: RGB(0, 0, 128);"><strong>ASIGNATURA.</strong></h3>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="responsive-table">
                      ...
                      $con=conectarMysql();
                      $result = $con->query("SELECT a.idasignatura,a.codigo_as, a.nombre_as, a.tipo_as,a.uv_as,a.ciclo_as,a.estado_as,a.prerequisito,a.postrequisito FROM asignatura as a WHERE a.tipo_as=2 and a.estado_as=1 
                      ...
                      if ($result) {
                        while ($fila = $result->fetch_object()) {
                          ...
                          echo "<td> <a class='btn btn-success btn-lg' onclick='modify(".$fila->idasignatura.")' ><i class='fa fa-edit'></i></a>
                                     <a class='btn btn-danger btn-lg' onclick='confirmar(".$fila->idasignatura.")' ><i class='fa fa-long-arrow-down'></i></a>
                                      </td>";
                          echo "</tr>";
                          $contador++;
