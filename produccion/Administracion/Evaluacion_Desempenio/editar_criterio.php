<?php
     ...
     $con=conectarMysql();
     $id=$_REQUEST['id'];
     $result = $con->query("SELECT * FROM ed_criterio WHERE ed_idcriterio=".$id);
     if ($result) {
       while ($fila = $result->fetch_object()) {
         $idcriterio=$fila->ed_idcriterio;
         $criterio=$fila->ed_ncriterio;
       }
     }
...
<script type="text/javascript">
        ...
        function cancelar(){
          swal({ 
            ...
            function(){
              //event to perform on click of ok button of sweetalert
              location.href='listar_criterio.php';
            });
          });
        }
      </script>s
            ...
            <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2 ">
              <div class="x_panel" >
                ...
                <div class="x_content">
                  ...
                  <input type="hidden" name="baccion" id="baccion" value="<?php echo $idcriterio; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="nombre" name="nombre" required="required" value="<?php echo $criterio; ?>" placeholder="Digite Nombre del Criterio" class="form-control col-md-7 col-xs-12" >
                      </div>
