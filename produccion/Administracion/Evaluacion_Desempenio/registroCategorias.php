...
<script type="text/javascript">
        ...
        function cancelar(){
          swal({ 
            ...
            function(){
              //event to perform on click of ok button of sweetalert
              location.href='registroCategorias.php';
            });
          });
        }
      </script>
     ...
     <?php include '../../global/navigation.php' ?>
      ...
      <div class="page-title">
            <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2 ">
              <h4 style="color: RGB(0, 0, 128);"><strong>ADMINISTRACI&Oacute;N DE CATEGORIAS.</strong></h4>
            </div> 
      </div>
      <div class="clearfix"></div>
      ...
      <div class="row" >
            <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2 ">
              <div class="x_panel" >
                <div class="x_title">
                  <h4 style="color:RGB(205, 92, 92);">Registrar Categoria.</h4>
                  <ul class="nav navbar-right panel_toolbox">
                  <li><a href="listarAula.php">Modificar Categoria</a>
                  </li>
                  </ul>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  ...
                  <input type="hidden" name="bandera" id="bandera">
                    ...
                    <h5> <strong><p style="color:RGB(0, 0, 128);"> Datos Categoria:</strong></p></h5>
