<?php
  require '../../../build/config/conexion.php';
    ...
    $aspector = $_REQUEST['id'];
    $con=conectarMysql();
    $cantmax=0;

    $consulta  = "SELECT ed.id_ed, ed.nombre_ed, ed.criterio_ed, ed.can_asp_ed, ed.estado_ed, asp.ed_idaspectos, asp.ed_nomasp FROM evaulaciond as ed, ed_aspectos as asp  WHERE asp.ed_idaspectos='$aspector' AND ed.id_ed=asp.id_edfk";
    $result = $con->query($consulta);
      if ($result) {
        while ($fila = $result->fetch_object()) {
            $nombre=$fila->nombre_ed;
            $criterio=$fila->criterio_ed;
            $aspecto=$fila->ed_nomasp;
                      
        }//fin while
      }
     // echo "exito";
     $consulta1  = "SELECT COUNT(ed_iditem) as maximo FROM ed_item WHERE ed_idaspectofk='$aspector'";
     $result1 = $con->query($consulta1);
       if ($result1) {
         while ($fila1 = $result1->fetch_object()) {
             $cantmax=$fila1->maximo+1;
...
<body class="nav-md">
     ...
     <?php include '../../global/navigation.php' ?>
      ...
      <div class="row" >
            <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2 ">
              <div class="x_panel" >
                <div class="x_title">
                  <h4 style="color:RGB(205, 92, 92);">Registro de Ítem por Aspecto a Evaluar <span style="color: #0B615E;"> "</span></h4>
                ...
                <div class="x_content">
                  ...
                  <input type="hidden" name="idasp" id="idasp" value="<?php echo $aspector; ?>">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Aspecto: <span style="color:	#000080;"> '</span>
                      </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id ="aspecto_ed" name ="aspecto_ed" value="<?php echo $aspecto; ?>" class="form-control col-md-7 col-xs-12"  disabled>
                      </div>
                    </div>
                   ...
                   <div id="insertaritem">
                    ...
                    <p style="color: #0B615E;">( " ) M&iacute;nimo 2 y M&aacute;ximo 8.</p>
  ...
  <script src="../../../build/config/validaciones/evaluacion_desempenio/validaritem.js"></script>
</body>
</html>
