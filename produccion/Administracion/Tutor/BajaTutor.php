...
$baja=$_GET["parametro"];
$query = $mysqli -> query ("SELECT * FROM empleado where idempleado=$baja");
?>
      ...
      <div class="main_container">
       ...
       <?php include '../../global/navigation.php'?>
        ...
        <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden"  value=" <?php echo $baja; ?>" />
            ...
            <input type="hidden" name="funcion_baja" value="baja" />
            <input type="hidden" name="cod_baja" value="<?php echo $baja; ?>" />
