...
$alta=$_GET["parametro"];
$query = $mysqli -> query ("SELECT * FROM empleado where idempleado=$alta");
?>
      ...
      <div class="main_container">
       ...
       <?php include '../../global/navigation.php'?>
        ...
        <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden"  value=" <?php echo $alta; ?>" />
            ...
            <input type="hidden" name="funcion_alta" value="alta" />
            <input type="hidden" name="cod_alta" value="<?php echo $alta; ?>" />
