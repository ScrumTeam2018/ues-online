       ...
       <?php include '../../global/navigation.php' ?>
        ...
        <div class="row" >
              <div class="col-sm-12 col-sm-offset-1 col-md-10 col-md-offset-1 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h3 style="color:RGB(205, 92, 92);">Lista de Aulas Activas.</h3>
                    ...
                    <div class="responsive-table">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>Ubicación de Aula</th>
                          <th>Capacidad de Aula</th>
                          <th>Acciones</th>
                        </tr>
                      </thead>
                      <tbody>
                      ...
                      $con=conectarMysql();
                      $result = $con->query("SELECT * FROM aula");
                      $contador=1;
                      if ($result) {
                        while ($fila = $result->fetch_object()) {
                          ...
                          echo "<td> <a class='btn btn-info btn-lg' onclick='modify(".$fila->idaula.")' ><i class='fa fa-edit'></i></a>
                                     <a class='btn btn-danger btn-lg' onclick='confirmar(".$fila->idaula.")' ><i class='fa fa-long-arrow-down'></i></a>
                                      </td>";
                          echo "</tr>";
                          $contador++;
