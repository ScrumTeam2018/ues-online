...
function modify(id){
  document.location.href='editarAula.php?id='+id;
}

function ver(id){
  $.ajax({
        type: 'POST',
        url: '../../../produccion/Administracion/aula/mostrarAula.php',
        data: {'id': id}
      })
      .done(function(listas_rep){
        $('.modal-body').html(listas_rep)
        $('#datosAula').modal({show:true});
      })
      .fail(function(){
  ...
  <body class="nav-md">
       ...
       <?php include '../../global/navigation.php' ?>
        ...
        <div class="row" >
          <!--    <div class="col-sm-12 col-sm-offset-1 col-md-10 col-md-offset-1 ">-->
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h4 style="color:RGB(205, 92, 92);">Lista de Aulas Activas.</h4>
                    <ul class="nav navbar-right panel_toolbox">
                    <li><a href="registroAula.php">Registrar Aula</a>
                    </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <div class="responsive-table">
                      ...
                      if ($result) {
                        while ($fila = $result->fetch_object()) {
                          ...
                          echo "<td> <a class='btn btn-success openBtn' type='button' onclick='ver(".$fila->idaula.")'><i class='fa fa-eye'></i></a>
                                     <a class='btn btn-info' onclick='modify(".$fila->idaula.")' ><i class='fa fa-edit'></i></a>
                                     <a class='btn btn-danger' onclick='confirmar(".$fila->idaula.")' ><i class='fa fa-long-arrow-down'></i></a>
                                      </td>";
                          echo "</tr>";
                          $contador++;
                    ...
                    <div class="modal-dialog ">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel" style="color: RGB(0, 0, 128);">Informaci&oacute;n Aula</h4>
                        </div>
                  ...
                  <!-- Fin Modal -->
                    ...
                    <div class="modal-dialog ">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel" style="color: RGB(0, 0, 128);">Aula</h4>
                        </div>
    ...
    <script src="../../../build/config/validaciones/aula/validarbaja.js"></script>
  </body>
</html>
