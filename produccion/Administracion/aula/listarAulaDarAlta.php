...
function ver(id){
  $.ajax({
        type: 'POST',
        url: '../../../produccion/Administracion/aula/mostrarAula1.php',
        data: {'id': id}
      })
  ...
  <body class="nav-md">
          ...
          <!--    <div class="col-sm-12 col-sm-offset-1 col-md-10 col-md-offset-1 ">-->
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <li><a href="registroAula1.php">Registrar Aula</a>
                    </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                      ...
                      if ($result) {
                        while ($fila = $result->fetch_object()) {
                          ...
                          echo "<td> <a class='btn btn-success openBtn' type='button' onclick='ver(".$fila->idaula.")'><i class='fa fa-eye'></i></a>
                                     <a class='btn btn-primary' onclick='confirmar(".$fila->idaula.")' ><i class='fa fa-long-arrow-up'></i></a>
                                      </td>";
                          echo "</tr>";
                          $contador++;
    ...
    <script src="../../../build/config/validaciones/aula/validaralta.js"></script>
  </body>
</html>
