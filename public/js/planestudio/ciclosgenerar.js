$('#ciclos').focusout(function() {
  ...
  for(var i=1; i<=x ; i++){
    if(i==x){
      ...
      "<button class='btn btn-round btn-primary' type='reset'><i class='fa fa-edit'> Finalizar</i></button>"+
      "</div>"+
      "</div>"+
  ...
  "que se encuentra dentro de public y un archivo js, llamado planestudio.js -->"+
  "<button class='btn btn-round btn-success' type='button'  value='add' id="+i+" onClick='agregar("+i+");'><i class='fa fa-plus'>  Agregar Nuevo</i></button>"+
  "<button class='btn btn-round btn-default' type='reset'><i class='fa fa-edit-o'> Guardado Temporal</i></button>"+
  "</div>"+
  "</div>"+
  "<div class='clearfix'></div>"+
  "<br><br>"+
